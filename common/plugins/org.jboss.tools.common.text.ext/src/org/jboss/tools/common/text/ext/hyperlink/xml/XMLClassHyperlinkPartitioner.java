...
public class XMLClassHyperlinkPartitioner extends AbstractHyperlinkPartitioner {
	...
	protected IHyperlinkRegion parse(final IDocument document, final int offset, final IHyperlinkRegion superRegion) {
		return StructuredModelWrapper.execute(document, new ICommand<IHyperlinkRegion>(){
	...
	public static IHyperlinkRegion getRegion(final IDocument document, final int offset) {
		return StructuredModelWrapper.execute(document, new ICommand<IHyperlinkRegion>(){
